...
def parse_args():
    ...
    parser.add_argument("--image-size", type=int, default=256, help="Spatial size of training images.")
    parser.add_argument("--epochs", type=int, default=DEFAULT_NUM_EPOCHS, help="Number of training epochs.")
    parser.add_argument("--lr", type=float, default=DEFAULT_LR_G, help="Generator learning rate for Adam.")
    parser.add_argument("--lr-d", type=float, default=DEFAULT_LR_D, help="Discriminator learning rate for Adam.")
...
def train():
    ...
    optimizerD = optim.Adam(netD.parameters(), lr=args.lr_d, betas=(args.beta1, DEFAULT_BETA2))
